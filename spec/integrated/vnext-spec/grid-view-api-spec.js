...
describe('grid view API verification', function () {
  ...
  it('data should be updated after set a new configuration to grid', function () {
    ...
    gridView = pgridInstance.gridView;
  ...
  it('verify status function for gridView', function () {
    let gridConfig = {
      el: '#container',
      dataSource: {
        type: 'memory',
  ...
  describe('Access the data item', function () {
    ...
    describe('keyOfElement()', function () {
      it('should get the key of the row', function () {
        return Promise.all([
    ...
    describe('itemWithKey()', function () {
      it('should get the item with the give key', function () {
        return driver
    ...
    describe('itemOfElement()', function () {
      it('should get the item from the DOM element', function () {
        return driver
